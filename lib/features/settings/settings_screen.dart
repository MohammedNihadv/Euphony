...
class SettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final appVersion = ref.watch(appVersionProvider).asData?.value ?? '0.2.11';
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Current Version: v${info?.currentVersion ?? ref.watch(appVersionProvider).asData?.value ?? '0.2.11'}',
